...
public class FileSearchResult implements Serializable, Comparable<FileSearchResult> {
	...
	public FileSearchResult(WordSearchMessage searchMessage, String fileName, String hash, long fileSize,
			String nodeAddress, int port) {
	...
	public static FileSearchResult[] getFileSearchResultFromFilesList(File[] files, String keyword, WordSearchMessage obj,  String endereco, int port) {
        if (files.length != 0) {
        	int counter = 0;
